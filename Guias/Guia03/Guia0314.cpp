 ...
 */
 ...
 /**
     * turnAround - Método para inverter a direção do movimento (virar 180º).
     */
    void turnAround()
    {
        turnLeft();
    ...
    /**
     * turnAroundCornerLeft - Método para fazer uma curva fechada à esquerda ("U"),
     * acompanhando uma parede interna.
     */
     ...
     case 6: // virar para o leste 
      ...
      case 7: // pegar marcador 
       ...
       case 9: // colocar marcador 
          ...
          break;
       case 10: //virar 180 graus    
           turnAround();
           break;
       case 11: //fazer curva fechada a esquerda
           if (leftIsClear())
        {
...
// executar tarefa
  char message [80]; 
  int quantidade = robot->readCommands ( comandos, "Tarefa0314.txt" ); 
    message [0] = '\0';              // limpar a mensagem 
    sprintf ( message, "Commands = %d", quantidade ); 
    show_Text ( message ); 
