...
/* 
   ...
   No Windows:   g++ -o Guia0205        Guia0205.cpp 
...
/* ---------------------------------------------- documentacao complementar 
 ---------------------------------------------- notas / observacoes / comentarios 
    ...
    Foi feita alterações na função 'pickBeepers' e colocada para funcionar dentro da função 'doSquare', e na hora de executar não houve erros no programa.
