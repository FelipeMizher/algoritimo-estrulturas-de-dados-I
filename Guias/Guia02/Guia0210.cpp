...
/* 
   ...
   No Windows:   g++ -o Guia0210        Guia0210.cpp 
...
/* ---------------------------------------------- documentacao complementar 
 ---------------------------------------------- notas / observacoes / comentarios 
   ...
   Foi adicionado uma nova função para acrescentar comandos ao arquivo traduzido, e na hora de executar não houve erros no programa.
