...
/* 
   Guia_0201 - v0.0. - 09 / 08 / 2023 
   Author: ____Felipe Rivetti Mizher______ 
 
   Para compilar em uma janela de comandos (terminal): 
    
   No Linux      :   g++ -o Guia0208      ./Guia0208.cpp 
   No Windows:   g++ -o Guia0208        Guia0208.cpp 
...
/* ---------------------------------------------- documentacao complementar 
 ---------------------------------------------- notas / observacoes / comentarios 
   ...
   Foi adicionada uma nova função para gravar as ações em um arquivo e um novo metodo para receber comandos direto do arquivo, e na hora de executar não houve erros no programa.
