...
*/
void inverterArray(int tamanho, int arranjo[]){
 // definir dados
    int inicio = 0;
    int fim = tamanho - 1;
 ...
 // Trocar o primeiro elemento com o último
        int temp = arranjo[inicio];
        arranjo[inicio] = arranjo[fim];
        arranjo[fim] = temp;
...
// repetir até desejar parar
 ...
 {
 // identificar
 IO_id ( "EXERCICIO-02 - Programa - v0.0" );
 // ler do teclado
 IO_println ( "Opcoes" );
 IO_println ( "0 - parar" );
