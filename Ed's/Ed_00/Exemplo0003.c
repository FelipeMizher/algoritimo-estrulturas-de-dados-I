...
/* 
   Exemplo0003 - v0.0. - 21 / 08 / 2023 
   Author: _____Felipe Rivetti Mizher _____ 
...
// definir dados / resultados 
 ...
 // identificar 
    ...
    printf ( "%s\n", "Autor: __Felipe Rivetti Mizher __" ); 
    printf ( "\n" ); // mudar de linha 
