...
// Pular linha.
    printf("\n");
// Verificar se existe algum valor do primeiro caractere é igual a algum outro e se o mesmo esta fora do intervalo dos outros dois.
    if ((Y < Z && (X < Y || X > Z)) || (Y > Z && (X < Z || X > Y))) {
        printf("O valor do primeiro caractere está fora do intervalo definido pelos outros dois.\n");
    } else if(X == Y || X == Z){
        printf("O primeiro valor é igual a pelo menos um dos outros dois.\n"); 
    } else {
        printf("O valor do primeiro caractere está dentro do intervalo definido pelos outros dois.\n");
    }
// Encerrar
    printf ( "\nApertar ENTER para continuar.\n" );
    getchar ( );
