...
bool allZerosLTriangleDoubleMatrix(int linha, int coluna, double matrix[][coluna]){
    ...
    return false;
} // end allZerosLTriangleDoubleMatrix
void method_19(){
 // definir dados
    int linha = 0;
    int coluna = 0;
 ...
 // chamar funções para ler e mostrar a diagonal secundaria da matrix
    ...
    if (allZerosLTriangleDoubleMatrix(linha, coluna, positiveMatrix)) {
        printf("\nExistem valores diferentes de '0' abaixo da diagonal principal.\n");
    } else {
        printf("\nTodos os valores na diagonal principal e abaixo dala são iguais a zero.\n");
    }    
 // encerrar
    IO_pause("Aperte ENTER para encerrar");
} // end method_19
...
void method_20(){
 ...
 // chamar funções para ler e mostrar a diagonal secundaria da matrix
    ...
    if(allZerosUTriangleDoubleMatrix(linha, coluna, positiveMatrix)){
        printf("\nTodos os valores acima da diagonal principal são zero.\n");
    } else {
        printf("\nPelo menos um valor diferente de '0' foi encontrado acima da diagonal principal.\n");
    }
 // encerrar
    IO_pause("Aperte ENTER para encerrar");
} // method_20
