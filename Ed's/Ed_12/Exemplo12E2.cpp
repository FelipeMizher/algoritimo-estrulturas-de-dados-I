...
{ 
 ...
 // chamar a função para verificar se o numero se encontra na matrix
    int result = matrix1.searchRows(N);

 // condição para se o valor for encontrado ou nao
    if(result != -1){
        cout << "\nO valor " << N << " foi encontrado na linha: " << result << "\n";
    } else{
        cout << "\nO valor " << N << " nao foi encontrado\n";
    }
...
{ 
 ...
 // chamar a função para verificar se o numero se encontra na matrix e em qual coluna
    int result = matrix1.searchColumns(N);
...
{ 
 ...
 // Imprimir matriz após a transposição
    cout << "\nMatrix transposta:\n";
    matrix1.print();
...
{ 
 ...
 // igualar uma variavel 'result' com o valor que é retornado da função
    int result = matrix1.emOrdemL();

 // Imprimir resultado de acordo com o que vem da função
    if(result == 1){
        cout << "A matrix esta em ordem crescente\n";
    } else{
        cout << "A matrix nao esta em ordem crescente\n";
    }
...
{ 
 ...
 // igualar uma variavel 'result' com o valor que é retornado da função
    int result = matrix1.emOrdemC();

 // Imprimir resultado de acordo com o que vem da função
    if(result == 1){
        cout << "A matrix esta em ordem crescente em relacao as colunas\n";
    } else{
        cout << "A matrix nao esta em ordem crescente em relacao as colunas\n";
    }
...
{ 
 ...
 // repetir até desejar parar 
    ...
    { 
     // identificar 
        cout << "EXEMPLO12E2 - Programa - v0.0\n    " << endl; 
     ...
     // mostrar opcoes 
        ...
        cout << "21 - method_E1 " << endl;
        cout << "22 - method_E2 " << endl;
