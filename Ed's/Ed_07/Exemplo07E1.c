...
void sequencia(char* fileName, int n){
    FILE* arquivo = fopen(fileName, "wt");
    int termo1 = 1;
    int termo2 = 1;
    int i = 0;
...
void method_18(){
 // definir dados
    ...
    double x = 0.0;
 // identificar
    IO_println ( "Methdo_18 - v0.0" );
 // pedir ao usuario um numero para 'n' 
    printf("%s\n", "Digite uma valor inteiro para 'n': ");
    scanf("%d" , &n); getchar();
 // executar metodo auxiliar
    sequencia("RESULTADO08.TXT", n);
 // encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // end method_18 ( )

void contar_maiuscula(char* fileName, char *str){
    FILE* arquivo = fopen(fileName, "wt");
    int count = 0;
    int i = 0;
    ...
    printf("\nO numero total de letras maiusculas e': %d\n" , count);
    fprintf(arquivo, "O numero total de letras maiusculas e': %d\n" , count);
...
void method_19(){
 // definir dados
    char texto[100];
 // identificar
    IO_println ( "Methdo_19 - v0.0" );
 // pedir ao usuario uma cadeia de caractere 
    printf("Digite uma cadeia de caracteres: ");
    fgets(texto, sizeof(texto), stdin);
 // executar metodo auxiliar
    contar_maiuscula("RESULTADO09.TXT", texto);
 // encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // end method_19 ( )

void contar_maiores_5(char* fileName, char *str){
    FILE* arquivo = fopen(fileName, "wt");
    int count = 0;
    int i = 0;
    ...
    printf("\nO numero total de digitos maiores que 5 e': %d\n" , count);
    fprintf(arquivo, "O numero total de digitos maiores que 5 e': %d\n" , count);
    
    fclose(arquivo);
} // end contar_maiores_5
/**
 Method_20
*/
void method_20(){
 // definir dados
    char texto[100];
 // identificar
    IO_println ( "Methdo_20 - v0.0" );
 // pedir ao usuario uma cadeia de caractere 
    printf("Digite uma cadeia de caracteres: ");
    fgets(texto, sizeof(texto), stdin);
 // executar metodo auxiliar
    contar_maiores_5("RESULTADO10.TXT", texto);
 // encerrar
 IO_pause ( "Apertar ENTER para continuar" );
} // end method_20 ( )
...
void method_21(){
 // definir dados
    ...
    int i = 0;
 // identificar
    IO_println ( "Methdo_21 - v0.0" );
 // pedir ao usuario um valor inteiro
    printf("%s" , "Digite um valor inteiro: ");
    scanf("%d" , &x); getchar();
 // abrir o arquivo
    FILE* arquivo = fopen("RESULTADO11.txt", "wt");
 // mostrar os divisores do numero digitado em ordem decrescente
